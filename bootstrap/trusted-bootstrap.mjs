...
function stagedLockName(name) { const match = new RegExp(`^${LOCK_STAGE_PREFIX.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')}(\\d+)-([0-9a-f-]{36})$`).exec(name); return match ? Number(match[1]) : null; }
