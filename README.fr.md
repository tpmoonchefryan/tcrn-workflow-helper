...
![status](https://img.shields.io/badge/status-0.1.0--candidate.17-blue) ![deps](https://img.shields.io/badge/dependencies-0-success) ![files](https://img.shields.io/badge/bootstrap-1%20file-brightgreen) ![force](https://img.shields.io/badge/--force-does%20not%20exist-critical)
...
# c18a6a9beee22eb6e6f5ec3b4d44159d882848e900dbd33bfee7516acbe694bd
```
...
Le rôle du helper est inchangé — prouver la release avant qu'elle ne s'exécute. Et la release qu'il épingle, TCRN Workflow `v0.1.0`, apporte une surface gouvernée que les références de la compétence apprennent à l'opérateur à piloter :
...
- `0.1.0-candidate.17` est un **candidat de pré-version** prenant en charge exactement TCRN Workflow `v0.1.0`.
