...
Le rôle du helper est inchangé — prouver la release avant qu'elle ne s'exécute. Et la release qu'il épingle, TCRN Workflow `v0.10.2`, apporte une surface gouvernée que les références de la compétence apprennent à l'opérateur à piloter :
...
- `0.1.0-candidate.30` est un **candidat de pré-version** prenant en charge exactement TCRN Workflow `v0.10.2`.
