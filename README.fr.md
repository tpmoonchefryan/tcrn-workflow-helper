...
![status](https://img.shields.io/badge/status-0.1.0--candidate.8-blue) ![deps](https://img.shields.io/badge/dependencies-0-success) ![files](https://img.shields.io/badge/bootstrap-1%20file-brightgreen) ![force](https://img.shields.io/badge/--force-does%20not%20exist-critical)
...
# fa7606e775a2dad1445f96f66a06f3d63dfd3d632712f165736d4fbfe5f15f98
```
...
- `0.1.0-candidate.8` est un **candidat de pré-version** prenant en charge exactement TCRN Workflow `v0.1.0-rc.6`.
