...
![status](https://img.shields.io/badge/status-0.1.0--candidate.7-blue) ![deps](https://img.shields.io/badge/dependencies-0-success) ![files](https://img.shields.io/badge/bootstrap-1%20file-brightgreen) ![force](https://img.shields.io/badge/--force-does%20not%20exist-critical)
...
# e5c19a20343111814213a4eea56bff380d47446a34eafb239146cb634d1788ce
```
...
**77 tests, tous hors ligne** (le seul usage de `node:net` est une fixture locale de socket de domaine Unix pour le rejet des fichiers spéciaux) :
...
| `test/` | La suite de preuves de 77 tests. |
...
Le rôle du helper est inchangé — prouver la release avant qu'elle ne s'exécute. Et la release qu'il épingle, TCRN Workflow `v0.1.0-rc.6`, apporte une surface gouvernée que les références de la compétence apprennent à l'opérateur à piloter :
...
- `0.1.0-candidate.7` est un **candidat de pré-version** prenant en charge exactement TCRN Workflow `v0.1.0-rc.6`.
