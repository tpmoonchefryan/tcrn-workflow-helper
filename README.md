...
The helper's job is unchanged — prove the release before it runs. The release it pins, TCRN Workflow `v1.0.0`, ships a governed surface that the Skill's references teach the operator to drive:
...
- `1.0.0` is a **first accepted release** supporting exactly TCRN Workflow `v1.0.0`.
