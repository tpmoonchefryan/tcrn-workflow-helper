...
The helper's job is unchanged — prove the release before it runs. The release it pins, TCRN Workflow `v0.11.8`, ships a governed surface that the Skill's references teach the operator to drive:
...
- `0.1.0-candidate.33` is a **pre-release candidate** supporting exactly TCRN Workflow `v0.11.8`.
