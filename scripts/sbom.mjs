...
const document = canonicalJson({
  ...
  documentNamespace:'https://github.com/tpmoonchefryan/tcrn-workflow-helper/spdx/tcrn-workflow-helper-0.1.0-candidate.2',
  name:'tcrn-workflow-helper-0.1.0-candidate.2',
  packages:[{ SPDXID:'SPDXRef-Package-tcrn-workflow-helper', copyrightText:'NOASSERTION', downloadLocation:'NOASSERTION', filesAnalyzed:false, licenseConcluded:'Apache-2.0', licenseDeclared:'Apache-2.0', name:'tcrn-workflow-helper', versionInfo:'0.1.0-candidate.2' }],
  relationships:[],
