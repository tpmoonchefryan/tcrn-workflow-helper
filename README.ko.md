...
![status](https://img.shields.io/badge/status-0.1.0--candidate.46-blue) ![deps](https://img.shields.io/badge/dependencies-0-success) ![files](https://img.shields.io/badge/bootstrap-1%20file-brightgreen) ![force](https://img.shields.io/badge/--force-does%20not%20exist-critical)
...
# a74c66c722a7bb21e6756e755af18afd8faa42a5bd6cd27228b13116ae73a008
```
...
helper의 역할은 그대로입니다 — 돌기 전에 릴리스를 증명하는 것. 그리고 지금 고정하고 있는 릴리스인 TCRN Workflow `v0.13.0`은, 스킬의 레퍼런스가 운영자에게 다루는 법을 가르치는 통제된 표면을 제공합니다.
...
- `0.1.0-candidate.46`는 **프리릴리스 후보**이며 정확히 TCRN Workflow `v0.13.0`을 지원합니다.
